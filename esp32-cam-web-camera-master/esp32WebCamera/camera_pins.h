...
// PWM通道设置
#define Servo_Ch_X 13 //PWM通道
#define Servo_Ch_Y 14 //PWM通道
//#define Servo_Ch_Z 15 //PWM通道
...
#define ServoX_Pin 2 //舵机X
#define ServoY_Pin 4 //舵机Y

#define Headlamp_Pin 4 //照明灯
#define MotorR_A_Pin 12 //右侧马达IN1驱动
#define MotorR_B_Pin 13 //右侧马达IN2驱动
#define MotorL_A_Pin 15 //左侧马达IN3驱动
#define MotorL_B_Pin 14 //左侧马达IN4驱动
